...
|---|---|
| Preamble & Recitals | Parties (Company, Founders, Investors), effective date, transaction context, consideration acknowledgment |
| Definitions | See definitions table below |
| ROFR Mechanism | Offering Notice → Company primary right → Investor secondary right → Overallotment → Closing |
| Co-Sale Rights | Tag-along notice → Pro rata participation → Price allocation → Transferee acceptance requirement |
| Transfer Restrictions | Prohibited transfers, Permitted Transfers, legend requirements, void ab initio remedy |
| Representations & Warranties | Authority, binding obligation, title to shares, no conflicts |
| Termination | IPO, change of control, majority/supermajority written consent |
| Miscellaneous | Governing law, notices, severability, integration, specific performance |
...
```
1. Proposed Transferor delivers Offering Notice → Company + all Major Holders
2. Company exercises primary ROFR (all or portion) within [30] days
3. If Company declines any portion → Major Holders exercise secondary ROFR
   pro rata within [15] days
...
```
1. ROFR not fully exercised → Proposed Transferor notifies Major Holders
   of co-sale right with all material sale terms
2. Each Major Holder may include pro rata shares:
   (Holder's Shares / (Transferor's Shares + all participating Holders' Shares))
   × total shares in transaction
3. Transferor reduces own sale quantity to accommodate participants
4. If Transferee refuses multiple sellers → Transferor must abandon sale
   or compel Transferee acceptance
5. Purchase price allocated pro rata per share among all selling parties
```

### Permitted Transfer Carve-Outs

- [x] Transfers to affiliates / controlled entities
- [x] Transfers to immediate family members
- [x] Transfers to revocable trusts for estate planning (settlor retains voting)
- [x] Transfers by will or intestate succession
- [x] Transfers pursuant to QDRO
- [x] **Condition**: all permitted transferees must execute joinder agreement

### Transfer Restriction Enforcement

- Attempted non-compliant transfer is **void ab initio**
- Company shall refuse to register on books or recognize transferee
...
- Address involuntary transfers (foreclosure, bankruptcy) — Company/Investors get ROFR before forced sale completes
...
- **Coordinate with companion agreements**: Ensure consistency with Investors' Rights Agreement (information rights, registration rights), Voting Agreement, and Certificate of Incorporation
- **Order of precedence**: Include express precedence clause if conflicts arise between this and other transaction documents
...
- **Schedules**: Attach Schedule of Founders, Schedule of Investors, and Schedule of Shares as exhibits
