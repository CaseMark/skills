...
Designs blended finance structures with DFI participation, concessional capital, and catalytic funding for emerging market investments.

## Workflow

1. **Gather** required inputs and define scope
2. **Process** information using appropriate methodology
3. **Analyze** results against standards or criteria
4. **Document** findings with supporting evidence
5. **Deliver** structured output with quality verification
...
- This skill operates within the **Cross-Border Capital** domain
- Relevant practice areas: International Finance, Cross-Border Transactions, Emerging Markets
