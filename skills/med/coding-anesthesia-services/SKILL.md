...
Assigns anesthesia codes with time documentation, base/time unit calculation, and physical status modifiers.
...
- This skill operates within the **Medical Coding and Billing** domain
- Relevant practice areas: Medical Coding, Revenue Cycle, Health Information Management
